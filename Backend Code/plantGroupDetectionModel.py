...
def detect_object(group_name, image_path):
    ...
    if white_dot_count == 0:
        print("None Found")
        return "None"
    elif white_dot_count < 10 and white_dot_count > 3:
...
def split_image(image_path):
    ...
    cv2.imwrite("./plantGroupDetection/splittedPhotos/left.png", left_image)
    cv2.imwrite("./plantGroupDetection/splittedPhotos/right.png", right_image)


# detect_object("groupLEFT", "./plantGroupDetection/splittedPhotos/left.png")
